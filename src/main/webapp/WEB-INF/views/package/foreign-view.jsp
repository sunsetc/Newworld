...
<button onclick="foreigninsert()">예약하기</button><br>
...
<script>
	...
	function foreigninsert() {
		location.href='/views/package/foreign-insert?giNum=${param.giNum}&riAdultCount=' + document.querySelector('#riAdultCount').value +
	...
	function getGoodsInfos() {
		fetch('/foreignGoods/${param.giCode}')
		.then(function(res) {
			return res.json();
		})
		.then(function(data) {
