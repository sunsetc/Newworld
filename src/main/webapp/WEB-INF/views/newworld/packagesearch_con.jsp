...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/packagesearch_con.css">
</head>
<body>
<div id="container">
<div id="cell">
...
<div class="page1">
        <div class="smallnav">
            <ul>
                ...
                <li><a href="/views/newworld/packagesearch">패키지조회</a></li>
            </ul>
        </div>
    ...
    <!-- 마이페이지 사이드메뉴 -->
    <div class="sidemeun">
            <h2 class="cusstmenu">패키지</h2>
            <ul class="submenu">
            <li class="qnamenu"><a href="/views/newworld/packagecountry">해외패키지</a></li>
            <li class="faqmenu"><a href="/views/newworld/packagekorea">국내패키지</a></li>
            </ul>
    </div>
...
<div class="packagepage">
    <h1 class="bigtitle">해외패키지 검색결과</h1><br>
...
$(document).ready(function () {
	...
	$.ajax({ // ajax로 데이터 가져오기
	method: "GET",
	url: "/goods-serch-etc?giName=${param.giName}&giEtc=${param.giEtc}",
	dataType: "json",
	success: function (d) {
...
/* var num;
window.onload = function getGoodsInfoByEtc() {
	const infos = document.querySelectorAll('th[data-col]');
	fetch('/goods-serch-etc?giName=${param.giName}&giEtc=${param.giEtc}')
	.then(function(res) {
		return res.json();
	})
	.then(function(data) {
