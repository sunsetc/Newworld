...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/packagekorea_gangwon.css">
</head>
<body>
<div id="container">
<div id="cell">
...
<div class="page1">		
        ...
        <div class="smallnav">
            <ul>
                ...
                <li><a href="/views/newworld/packagekorea">국내패키지</a>></li>
                <li><a href="/views/newworld/packagekorea_gangwon">강원도</a></li>
            </ul>
        </div>
    ...
    <!-- 패키지화면 사이드메뉴 -->
	<%@ include file="/WEB-INF/views/common/packagemenukor.jsp" %>
...
<div class="packagepage">
    <h1 class="bigtitle">강원도</h1><br>
   
   <!-- 탭메뉴 -->
    <ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link" href="/views/newworld/packagecountry">해외패키지</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="/views/newworld/packagekorea">국내패키지</a>
  </li>
</ul>
