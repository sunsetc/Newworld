...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/packagesearch.css">
</head>
<body>
<div id="container">
<div id="cell">
...
<div class="packagepage">
    <h1 class="bigtitle">패키지 검색결과</h1><br>
...
$(document).ready(function () {
	...
	$.ajax({ // ajax로 데이터 가져오기
	method: "GET",
	url: "/goods-Search?giName=${param.giName}",
	dataType: "json",
	success: function (d) {
...
/* function getGoodsInfos() {
	const infos = document.querySelectorAll('th[data-col]');
	fetch('/goods-Search?giName=${param.giName}')
	.then(function(res) {
		return res.json();
	})
	.then(function(data) {
