...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/reservationlist.css">
</head>
<body>
<div id="container">
<div id="cell">
...
<!-- 마이페이지 사이드메뉴 -->
    ...
    <!-- 패키지내역 메인 -->
<div class="notepage">
    <h1 class="bigtitle">패키지 예약내역</h1><br>
	
	<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="/views/newworld/reservationlist">전체보기</a>
  </li>
   <li class="nav-item">
    <a class="nav-link" href="/views/newworld/reservationcountrylist">해외예약조회</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="/views/newworld/reservationkorealist">국내예약조회</a>
  </li>
</ul>
...
function displayData(currentPage, dataPerPage) {
	...
	if(totalData === 0) {
		document.querySelector('.table-striped').style.display = 'none';
 		html += '<p style="color: gray; text-align: center; line-height: 50px;">예약 내역이 없습니다.</p>'
		$('#reservnone').html(html);
	}else {
		for (
