...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/packagecountry_us.css">
</head>
<body>
<div id="container">
<div id="cell">
...
<div class="page1">      
        ...
        <div class="smallnav">
            <ul>
                ...
                <li><a href="/views/newworld/packagecountry_us">미국</a></li>
            </ul>
        </div>
...
function displayData(currentPage, dataPerPage) {
	...
	i++
			...
			html += '<tr onclick="location.href=\'/views/newworld/packageview?giCode=' + goodsInfos.giCode + '\'">' + '<td style="font-size:26px; font-weight:bold; cursor: pointer;">' + '<a href="#">' + goodsInfos.giName + '</td>' + '</tr>';
