...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/reservationcountrylist.css">
</head>
<body>
<div id="container">
<div id="cell">
...
<!-- 마이페이지 사이드메뉴 -->
    ...
    <!-- 패키지내역 메인 -->
<div class="notepage">
    <h1 class="bigtitle">해외패키지 예약내역</h1><br>
  ...
  <li class="nav-item">
   ...
   <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="/views/newworld/reservationcountrylist">해외예약조회</a>
  </li>
  <li class="nav-item">
