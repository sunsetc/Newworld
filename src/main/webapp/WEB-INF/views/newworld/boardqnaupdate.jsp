...
<div class="page1">
        ...
        <div class="smallnav">
            <ul>
                ...
                <li><a href="/views/newworld/boardqnaupdate">1:1문의 수정</a></li>
            </ul>
        </div> 
...
<!-- 고객센터 사이드메뉴 -->
    ...
    <!-- 공지사항 메인 -->
<div class="qnapage">
    <h1 class="bigtitle">1:1문의 수정</h1><br>
    ...
    <table class="table table table-border w-100">
        <tbody>
          ...
          <tr>
            ...
            <td><select id="selectCode" onchange="selectWriteCode()"><input type="text" id="inputCode"><button>예약번호 조회</button></td>
          </tr>
    ...
    <button class="qnainsert" onclick="updateBoardInfo()">등록</button>
</div>
...
<script>
function getBoardQna() {  //제목, 내용 불러오기
	...
	.then(function(res) {
		...
		.then(function(list) {
			console.log(list);
			document.querySelector('#bqTitle').value = list.bqTitle;
			document.querySelector('#bqContent').innerHTML = list.bqContent;
		})
}
...
window.addEventListener('load',function getReservCode(){  //1:1문의 예약번호 최신순으로 5개만 불러오기
