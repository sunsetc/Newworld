...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/packagecountry_as.css">
</head>
<body>
<div id="container">
<div id="cell">
...
<div class="page1">        
        ...
        <div class="smallnav">
            <ul>
                ...
                <li><a href="/views/newworld/packagecountry_as">아시아</a></li>
            </ul>
        </div>
...
function displayData(currentPage, dataPerPage) {
	...
	i++
			...
			console.log(num);
			html += '<tr>';
			html += '<th scope="row" rowspan="6" style="cursor: pointer;">' + '<a href="#">' + '<img src="' + goodsInfos.giImage1 + '"width="300px" onclick="location.href=\'/views/newworld/packageview?giCode=' + goodsInfos.giCode + '\'">' + '</a>' + '</th>';
			html += '<tr onclick="location.href=\'/views/newworld/packageview?giCode=' + goodsInfos.giCode + '\'">' + '<td style="cursor: pointer; font-size:26px; font-weight:bold;">' + '<a href="#">' + goodsInfos.giName + '</td>' + '</tr>';
			html += '<tr>' + '<td>' + goodsInfos.giHashtag + '</td>' + '</tr>';
			html += '<tr>' + '<td>' + '기간: ' + goodsInfos.giPeriodAbout + '</td></tr>';
			html += '<tr>' + '<td>' + goodsInfos.giPeriod + '</td></tr>';
			html += '<tr style="text-align: right;">' + '<td style="cursor: pointer;" onclick="location.href=\'/views/newworld/packageview?giCode=' + goodsInfos.giCode + '\'">' + '<a href="#"  style="font-size:26px; font-weight:bold; color:#4374D9">' + num + '원' + '</a>' + '</td>';
...
function goAS() {
	...
	.then(function(data) {
		...
		for(let i = 0; i < data.length; i++) {
			...
			console.log(num);
			html += '<tr>';
			html += '<th scope="row" rowspan="6">' + '<a href="#">' + '<img src="' + goodsInfos.giImage1 + '"width="300px" onclick="location.href=\'/views/newworld/packageview?giNum=' + goodsInfos.giNum + '&giCode=' + goodsInfos.giCode + '\'">' + '</a>' + '</th>';
			html += '<tr onclick="location.href=\'/views/newworld/packageview?giNum=' + goodsInfos.giNum + '&giCode=' + goodsInfos.giCode + '\'">' + '<td style="font-size:26px; font-weight:bold;">' + '<a href="#">' + goodsInfos.giName + '</td>' + '</tr>';
			html += '<tr>' + '<td>' + goodsInfos.giHashtag + '</td>' + '</tr>';
			html += '<tr>' + '<td>' + '기간: ' + goodsInfos.giPeriodAbout + '</td></tr>';
			html += '<tr>' + '<td>' + goodsInfos.giPeriod + '</td></tr>';
			html += '<tr style="text-align: right;">' + '<td onclick="location.href=\'/views/newworld/packageview?giNum=' + goodsInfos.giNum + '&giCode=' + goodsInfos.giCode + '\'">' + '<a href="#"  style="font-size:26px; font-weight:bold; color:#4374D9">' + num + '원' + '</a>' + '</td>';
			for(const info of infos) {
				html += '<td>' + goodsInfos[info.getAttribute('data-col')] + '</td>';
			}
			html += '</tr>';
